...
//                );
//
//            mWidgetEventListenerConfig->setSourceEventsList(
//                {
...
//            );
//
//            mWidgetEventListenerConfig->setTargetEventsList(mWidgetEventListenerConfig->getSourceEventsList());
