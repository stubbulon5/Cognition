...
//===================================================================
    ...
    shared_ptr<Note> copy(){
        if(isValid()){
            ...
            cout << __FUNCTION__<<" trying to copy empty note"<<endl;
            return 0;
        }
    }
...
//===================================================================
    ...
    void set(int note, Dynamics _dyn=Dynamics(),bool absolute = true){
        ...
        if(absolute){
            ...
            if(note<0 || note>11){
                cout << note<<" outside note range 0-11"<<endl;
                return;
            }else{
                name = n[note];
                octave = 3;
...
//===================================================================
    ...
    static bool isValidName(string _name){
        ...
        if(!rex.search(_name)){
            cout << "The string "<<_name<<" is not a valid representation of a note"<<endl;
            return false;
        }else{
            return true;
        }
    ...
    static shared_ptr<Note> fromInt(int val){
        if(val<0){
            cout << "Negative note value not allowed "<<val<<endl;
            return 0;
        }
        int relVal = val % 12;
