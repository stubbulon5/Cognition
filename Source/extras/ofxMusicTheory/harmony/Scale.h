...
//===================================================================
    ...
    static deque<NotePtr> offset(deque<NotePtr> orgscale,int amount){
        if(!(orgscale.size()>amount)){
            cout <<__FUNCTION__<<" not enough notes"<<endl;
            return orgscale;
        }
        deque<NotePtr> scale;
    ...
    NotePtr getFirst(){
        if(isValid()){
            ...
            cout <<"Scale::getFirst has no notes"<<endl;
        }
    }
    ...
    */
    NotePtr getThird(){
        if(isValid()){
            ...
            cout <<"Scale does not contain a third"<<endl;
            return 0;
        }else{
            cout <<"Scale invalid"<<endl;
        }
    ...
    NotePtr getSeventh(){
        if(isValid()){
            ...
            cout <<"Scale does not contain a seventh"<<endl;
            return 0;
        }else{
            cout <<"Scale invalid"<<endl;
        }
