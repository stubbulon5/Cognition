/*
  ==============================================================================
    ...
    uiVizWigetStringedInstrument.h
    Created: 17 Mar 2024 8:40:35am
    Author:  Zabba
...
public:
    ...
    {
        uiVizWidgetMusical::paint(g);
        
        g.setColour (juce::Colours::wheat);
        const juce::Rectangle r =juce::Rectangle(getBounds().getX() + 10, getBounds().getY() + 10, getBounds().getWidth() - 20, getBounds().getHeight() - 20);
        ...
        for (int i=0; i<=6; i++) {
            int y = r.getY() + i*r.getHeight()/6;
            g.drawLine(r.getX(), y, getBounds().getX() + r.getWidth()+10, y);
        }
    ...
    virtual void resized() override
    {
        ...
        uiVizWidgetMusical::resized();
    }

private:
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (uiVizWigetStringedInstrument)
};
...
//            }
//
//            if (note.isEnharmonicallyEquivalent(getSelectedKey().getNoteName()))
//            {
