...
private:
    ...
    void initWidget() override {
        ...
        if (!ChordProgressionContextMenu) {
            ...
            ChordProgressionContextMenu = new uiVizWidgetMenu(getWidgetId() + "_CP_MENU1", "<widget><bounds width='100' height='300'/></widget>", getWidgetId()
               ...
               // ----------------------------------------------------------------------------
                // Key Picker menu
                // ----------------------------------------------------------------------------
                uiVizWidgetMenuTab(uiVizShared::lang("KEY_PICKER"), uiVizIconCache::getIcon("MED_CONTENT_THEORY_LABEL"),
            ...
            ofAddListener(dynamic_cast<uiVizWidgetMenu*>(ChordProgressionContextMenu)->menuItemSelected, this, &uiVizWidgetChordProgression::onMenuItemSelected);
            
            uiVizWidgetManager::addWidget(*ChordProgressionContextMenu, false, getWidgetId());
        }
