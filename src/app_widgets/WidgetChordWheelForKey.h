...
class WidgetChordWheelForKeySlice {
public:
    vizChord chord;
    ...
    ~WidgetChordWheelForKeySlice() {
    }
    
};

class WidgetChordWheelForKey : public WidgetMusical {

public:
   
    WidgetChordWheelForKey(string persistentId, string widgetXML) : WidgetMusical(persistentId, widgetXML) {
        initWidget();
        loadState(widgetXML);
    }
    ...
    virtual ~WidgetChordWheelForKey() {
    ...
    void setSliceProperties(WidgetChordWheelForKeySlice *slice,
    ...
    void update(Aquamarine::WidgetContext context) override {
        ...
        for (int i = 1; i <= circleSlicesT1.size() ; i++) {
            ...
            WidgetChordWheelForKeySlice *sliceT1 = &circleSlicesT1[i-1];
            ...
            WidgetChordWheelForKeySlice *sliceT2 = &circleSlicesT2[i-1];
    ...
    void drawSlice(int tier, int currentSlice, WidgetChordWheelForKeySlice &slice) {
    ...
    virtual void addSelectedChord(vizChord &chord, bool onlyAddIfNotFound, bool includeInstrumentRules) override {
        ...
        if(chord.isMinor()) {
            WidgetMusical::setSelectedScale(vizScale(chord.getChordRoot(), "aeolian", 3), includeInstrumentRules);
        } else {
            WidgetMusical::setSelectedScale(vizScale(chord.getChordRoot(), "ionian", 3), includeInstrumentRules);
        }

        clearSelectedChords();
        WidgetMusical::addSelectedChord(chord, onlyAddIfNotFound, includeInstrumentRules);
        // WidgetMusical::setSelectedScale(chord.getChordRoot(), includeInstrumentRules);
        initScale();
        // T1Alternator = 1;
    }    
...
private:
    ...
    vector<WidgetChordWheelForKeySlice> circleSlicesT1;
    vector<WidgetChordWheelForKeySlice> circleSlicesT2;
    // vector<WidgetChordWheelForKeySlice> circleSlicesT3;
    ...
    void initScale() {
        ...
        WidgetChordWheelForKeySlice sliceT1_I, sliceT1_II, sliceT1_III, sliceT1_IV, sliceT1_V, sliceT1_VI, sliceT1_VII;
        WidgetChordWheelForKeySlice sliceT2_I, sliceT2_II, sliceT2_III, sliceT2_IV, sliceT2_V, sliceT2_VI, sliceT2_VII;
    ...
    void initWidget() override {
        ...
        if (!chordWheelContextMenu) {
            ...
            ofAddListener(dynamic_cast<Aquamarine::WidgetMenu*>(chordWheelContextMenu)->menuItemSelected, this, &WidgetChordWheelForKey::onMenuItemSelected);
    ...
    ofColor getLabelStateColor(WidgetChordWheelForKeySlice slice) {
        if (slice.isHovered)  {
