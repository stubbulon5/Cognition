...
class WidgetLicence : public Aquamarine::Widget {
...
public:
    ...
    void displayValidationResult(Licence licence) {
        Aquamarine::WidgetElmLabel* LBL_VALIDATION_RESULT = getLabel("LBL_VALIDATION_RESULT");
        if (licence.isValid) {
...
private:
    ...
    Aquamarine::WidgetElmTextbox* TXT_USERNAME;
    Aquamarine::WidgetElmTextbox* TXT_PASSWORD;
    Aquamarine::WidgetElmTextbox* TXT_LICENCE;
    Aquamarine::WidgetElmProgressBar* PGS_VALIDATION_RESULT;
