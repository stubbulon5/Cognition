 ...
 ***********************************************************************************/
class WidgetStringedInstrumentString
{
public:
    vizNote note;
    ...
    WidgetStringedInstrumentString() {}
    WidgetStringedInstrumentString(vizNote note, int thickness) : note(note), thickness(thickness) {}
    WidgetStringedInstrumentString(vizNote note, int thickness, int offset) : note(note), thickness(thickness), offset(offset) {}
    WidgetStringedInstrumentString(vizNote note, int thickness, ofColor color) : note(note), thickness(thickness), color(color) {}
    WidgetStringedInstrumentString(vizNote note, int thickness, int offset, ofColor color) : note(note), thickness(thickness), offset(offset), color(color) {}
...
class WidgetStringedInstrumentFret
{
public:
    Aquamarine::Elm path;
    Aquamarine::Elm inlayPath;
    bool hasInlay = false;
    float fretPos = 0.0f;
    float prevFretDist = 0.0f;
    float fretDist = 0.0f;
    Aquamarine::Elm fretArea;

    ofColor color = ofColor(0, 0, 0, 180);
    ofColor disabledColor = ofColor(0, 0, 0, 45);

    ~WidgetStringedInstrumentFret()
    {
    }
};

class WidgetStringedInstrumentPoint
{
public:
    WidgetStringedInstrumentString *instrumentstring;
    int fret;
    bool isHovered = false;
    bool isSelected = false;
    Aquamarine::Elm path, highlightPath;
    ...
    WidgetStringedInstrumentPoint(WidgetStringedInstrumentString *string, int fret) : instrumentstring(string), fret(fret) { initNote(string, fret); }
    WidgetStringedInstrumentPoint(WidgetStringedInstrumentString *string, int fret, bool isExtended) : instrumentstring(string), fret(fret), isExtended(isExtended) { initNote(string, fret); }
    WidgetStringedInstrumentPoint(WidgetStringedInstrumentString *string, int fret, bool isExtended, int sequenceNumber) : instrumentstring(string), fret(fret), isExtended(isExtended), sequenceNumber(sequenceNumber) { initNote(string, fret); }
    WidgetStringedInstrumentPoint(WidgetStringedInstrumentString *string, int fret, ofColor color) : instrumentstring(string), fret(fret), color(color) { initNote(string, fret); }
...
private:
    ...
    void initNote(WidgetStringedInstrumentString *string, int fret)
    {
...
class WidgetStringedInstrument : public WidgetMusical
{
...
public:
    ...
    WidgetStringedInstrument(string persistentId, string widgetXML) : WidgetMusical(persistentId, widgetXML)
    {
        initWidget();
        ...
        /************************************
         ...
         -------------------------------------------------------------
         We do NOT load state inside WidgetStringedInstrument constructor since it's acts more like an
         interface. It is up to the derriving widget eg WidgetGuitar to load it's state from it's own
         constructor.
        ************************************/
    }
    ...
    virtual bool loadState(string widgetXML) override
    {
        ...
        vector<WidgetStringedInstrumentString> strings = getStringsFromXML(settings);
    ...
    virtual ~WidgetStringedInstrument()
    {

        Aquamarine::WidgetMenu *menu = static_cast<Aquamarine::WidgetMenu *>(instrumentContextMenu);
        if (menu) 
            ofRemoveListener(menu->menuItemSelected, this, &WidgetStringedInstrument::onMenuItemSelected);

        Aquamarine::WidgetMenu *menuMini = static_cast<Aquamarine::WidgetMenu *>(instrumentContextMenuMini);
        if (menu) 
            ofRemoveListener(menuMini->menuItemSelected, this, &WidgetStringedInstrument::onMenuItemSelected);            

        if (keyPickerMenuItem)
            ofRemoveListener(keyPickerMenuItem->keySelected, this, &WidgetStringedInstrument::onKeyPickerMenuKeySelected);
        
        if(chordDesignerMenuItem) {
            ofRemoveListener(chordDesignerMenuItem->noteSelected, this, &WidgetStringedInstrument::onChordDesignerMenuNoteSelected);
            ofRemoveListener(chordDesignerMenuItem->userDefinedChordNameChanged, this, &WidgetStringedInstrument::onUserDefinedChordNameChanged);
            ofRemoveListener(chordDesignerMenuItem->rulesChanged, this, &WidgetStringedInstrument::onRulesChanged);            
        }


        if(scalePickerMenuItem) {
            ofRemoveListener(scalePickerMenuItem->noteSelected, this, &WidgetStringedInstrument::onScalePickerMenuNoteSelected);
            ofRemoveListener(scalePickerMenuItem->rulesChanged, this, &WidgetStringedInstrument::onRulesChanged);
        } 
    ...
    static void appendStringsToXML(ofxXmlSettings &settings, vector<WidgetStringedInstrumentString> strings) {
    ...
    vector<WidgetStringedInstrumentString> getStringsFromXML(ofxXmlSettings &settings)
    {

        vector<WidgetStringedInstrumentString> strings = vector<WidgetStringedInstrumentString>();
        ...
        if (settings.pushTag("strings"))
        {
            if (settings.getNumTags("string") > 0)
            {
                ...
                for (int j = 0; j < settings.getNumTags("string"); j++)
                {
                    ...
                    WidgetStringedInstrumentString string = WidgetStringedInstrumentString(
    ...
    virtual int getUsableX() override
    {
        ...
        {
            return Widget::getUsableX(true) + mTOOLBAR_WIDTH;
        }
        else
        {
            return Widget::getUsableX();
        }
    }
    ...
    virtual int getUsableWidth() override
    {
        ...
        if (getTheoryVizOrientationMode() == TheoryVizOrientationMode::VERTICAL && getIsChordDiagramMode())
        {
            return Widget::getUsableWidth() - mTOOLBAR_WIDTH;
        }
        else
        {
            return Widget::getUsableWidth();
        }
    }
    ...
    virtual void updateFrets(float sizingRatio)
    {
		...
		***********************************************************************************************/
        ...
        for (int i = 1; i <= mTotalFrets; i++)
        {
            ...
            WidgetStringedInstrumentFret f = WidgetStringedInstrumentFret();
    ...
    virtual void updateFretboardInlay(WidgetStringedInstrumentFret *f, float sizingRatio, int fretNum, float fretWidth)
    {
            ...
            fretNum == 15 || fretNum == 17 || fretNum == 19 || fretNum == 21 || fretNum == 24)
        {
            ...
            Aquamarine::Elm::vizRect rect = f->path.getRectangle();
    ...
    virtual void updatePoints(float sizingRatio, int fretboardWidth)
    {
        ...
        for (int i = 0; i < getPoints().size(); i++)
        {
            Aquamarine::Elm::vizRect stringRect = mPoints[i].instrumentstring->path.getRectangle();
            Aquamarine::Elm::vizRect pointRect = mPoints[i].path.getRectangle();
            ...
            if (note.isEnharmonicallyEquivalent(getSelectedKey().getNoteName()) || note.getIsPlaying())
            {
                ...
                Aquamarine::Elm::vizRect r = mPoints[i].path.getRectangle();
    ...
    virtual void update(Aquamarine::WidgetContext context) override
    {
        ...
        if (context.drawContext == Aquamarine::WidgetContext::DrawContext::IMAGE)
        {
    ...
    virtual void draw(Aquamarine::WidgetContext context) override
    {
        ...
        {
            // Point
            WidgetStringedInstrumentPoint fretPoint = getPoints()[i];
        ...
        if (getFrets().size() > 0 && lowestStartingFret > 0 && getIsChordDiagramMode()) 
        {
            ...
            fontLarge->draw(label,
                            scale(Widget::getUsableX()) + (label.length() >= 2 ? getNonScaledPadding() * -1.0f : getToolbarWidth() / 2.0f),
                ...
                for (int j = 0; j < getFrets().size(); j++)
                {
                    ...
                    {   // &&
                        ...
                        if (getStrings()[i].isEnabled && !pointWasAdded)
                        {
                            ...
                            WidgetStringedInstrumentPoint point = WidgetStringedInstrumentPoint(getString(i), nutIsHovered ? 0 : clickedFret, color);
...
*/
    ...
    int getNumNotesAddedToString(WidgetStringedInstrumentString *string, vector<WidgetStringedInstrumentPoint> points)
    {
    ...
    vector<WidgetStringedInstrumentPoint> getPointsForNotes(vector<vizNote> notes, vizNote rootNote, vizTheoryBase theoryObj)
    {
        ...
        vector<WidgetStringedInstrumentPoint> points = {};
                ...
                while (f != fretVector)
                {
                    ...
                    for (int i = 0; i < notes.size(); i++)
                    {
                        ...
                        if (currStringNote.isEnharmonicallyEquivalent(noteName) && (!rule_exactOctaveMatch || (rule_exactOctaveMatch && matchesOctave)))
                        {
                            ...
                            {
                                WidgetStringedInstrumentPoint pointToAdd = WidgetStringedInstrumentPoint(getString(s), f, currStringNote.getNoteColor());
        ...
        if (getTheoryVizInstrumentTheoryContentMode() == TheoryVizInstrumentTheoryContentMode::CHORD)
        {
            if (rule_showExtendedNoteNames)
            {
                ...
                for (WidgetStringedInstrumentPoint &point : points)
                {
    ...
    bool pointExistsInVector(WidgetStringedInstrumentPoint pointToAdd, vector<WidgetStringedInstrumentPoint> points)
    {
    ...
    bool addSelectedNotesFromPointsForChord(bool isUserDefinedPoints)
    {
        ...
        for (int s = 0; s < getStrings().size(); s++)
        {
            ...
            {
                WidgetStringedInstrumentString *currString = getPoints()[p].instrumentstring;
        ...
        if ((chord.isChordValid() || chordNormalized.isChordValid()))
        {
            ...
            if (chord.isChordValid())
            {
                WidgetMusical::addSelectedChord(chord, true, true);
            ...
            {
                WidgetMusical::addSelectedChord(chordNormalized, true, true);
        ...
        else
        {
            ...
            WidgetMusical::addSelectedChord(unknownChord, true, true);
    ...
    bool addSelectedNotesFromPointsForScale()
    {
        ...
        if (scale.isScaleValid() || scaleNormalized.isScaleValid())
        {
            ...
            if (scale.isScaleValid())
            {
                WidgetMusical::setSelectedScale(scale, true);
            ...
            {
                WidgetMusical::setSelectedScale(scaleNormalized, true);
    ...
    vector<WidgetStringedInstrumentPoint> trimStringPointsOutsideFretRange(
        vector<WidgetStringedInstrumentPoint> userDefinedFretPoints, int lowestStartingFret, int highestEndingFret)
    {

        vector<WidgetStringedInstrumentPoint> tmp_userDefinedFretPoints;
        for (WidgetStringedInstrumentPoint point : userDefinedFretPoints)
        {
    ...
    void optimizeFretRangeForCurrentStringPoints()
    {
        ...
        for (WidgetStringedInstrumentString currString : getStrings())
        {
            vector<WidgetStringedInstrumentPoint> stringPoints = getFretPointsForString_From_CSV(&currString);
            for (int j = 0; j < stringPoints.size(); j++)
            {
                WidgetStringedInstrumentPoint fretPoint = stringPoints[j];
    ...
    void calculatePointsForChord()
    {
        ...
        if (isUserDefinedPoints)
        {
            ...
            vector<WidgetStringedInstrumentPoint> userDefinedFretPoints;

            for (int s = 0; s < getStrings().size(); s++)
            {
                WidgetStringedInstrumentString *currString = getString(s);
                vector<WidgetStringedInstrumentPoint> fretPoints = getFretPointsForString_From_CSV(currString);
    ...
    void plotDiagnosticPoints()
    {
        ...
        vector<WidgetStringedInstrumentPoint> diagnosticPoints = {};
        for (int i = 0; i <= mTotalFrets; i++)
        {
            for (int j = 0; j < mStrings.size(); j++)
            {
                ofColor color = mStrings[j].note.calculateNoteKeyColor(i);
                diagnosticPoints.push_back(WidgetStringedInstrumentPoint(getString(j), i, color));
            }
        }
    ...
    string getPointLabelForState(vizNote note, WidgetStringedInstrumentPoint point)
    {
    ...
    vector<WidgetStringedInstrumentFret> getFrets()
    {
        return mFrets;
    }

    void setFrets(vector<WidgetStringedInstrumentFret> frets)
    {
        mFrets = frets;
    }

    virtual vector<WidgetStringedInstrumentString> getStrings()
    {
        return mStrings;
    }

    vector<WidgetStringedInstrumentString> getStringsFromRules()
    {
        ofxXmlSettings settings = getInstrumentRules();
        return getStringsFromXML(settings);
    }

    vector<WidgetStringedInstrumentString> getStringsFromRules(vizTheoryBase theoryObj)
    {
    ...
    virtual WidgetStringedInstrumentString *getString(int string)
    {
        return &mStrings[string];
    }

    virtual void setStrings(vector<WidgetStringedInstrumentString> strings, bool shouldUpdateRules)
    {
    ...
    void synchronizeStringsEnabledPropertyWithMenu()
    {
        ...
        vector<Aquamarine::WidgetMenuSlice> *menuSlices = menu->getMenuTabSlice(MENU_GROUP_1::MENU_TAB_STRINGS);
        vector<Aquamarine::WidgetMenuSlice> &menuSlicesRef = *menuSlices;
    ...
    void synchronizeMenuWithStartFretProperty()
    {
        ...
        vector<Aquamarine::WidgetMenuSlice> *menuSlices = menu->getMenuTabSlice(MENU_GROUP_1::MENU_TAB_START_FRET);
        vector<Aquamarine::WidgetMenuSlice> &menuSlicesRef = *menuSlices;
    ...
    void synchronizeMenuWithEndFretProperty()
    {
        ...
        vector<Aquamarine::WidgetMenuSlice> *menuSlices = menu->getMenuTabSlice(MENU_GROUP_1::MENU_TAB_END_FRET);
        vector<Aquamarine::WidgetMenuSlice> &menuSlicesRef = *menuSlices;
    ...
    vector<WidgetStringedInstrumentPoint> getFretPointsForString(WidgetStringedInstrumentString *currString)
    {
        vector<WidgetStringedInstrumentPoint> stringPoints;
        for (int i = 0; i < getPoints().size(); i++)
        {
    ...
    vector<WidgetStringedInstrumentPoint> getFretPointsForString_From_CSV(WidgetStringedInstrumentString *currString)
    {
        vector<WidgetStringedInstrumentPoint> stringPoints;
        ...
        for (string point : points)
        {
            ...
            if (ofTrim(point) == "0")
            {
                stringPoints.push_back(WidgetStringedInstrumentPoint(currString, 0, isExtendedNote, sequenceNumber));
            }
            else
            {
                int intVal = std::atoi(point.c_str());
                if (intVal != 0)
                    stringPoints.push_back(WidgetStringedInstrumentPoint(currString, intVal, isExtendedNote, sequenceNumber));
            }
        }
        return stringPoints;
    }

    string getFretPointsForString_CSV(WidgetStringedInstrumentString *currString)
    {
        vector<WidgetStringedInstrumentPoint> stringPoints = getFretPointsForString(currString);
        string fretPoints = "";
        for (int i = 0; i < stringPoints.size(); i++)
        {
            WidgetStringedInstrumentPoint fretPoint = stringPoints[i];
    ...
    vector<WidgetStringedInstrumentPoint> getPoints()
    {
        return mPoints;
    }
    ...
    int getTotalSequencedPoints() {
        ...
        for(WidgetStringedInstrumentPoint point:mPoints) {
            if (point.sequenceNumber > 0) {
                sequencedPoints++;
            }
        }
    ...
    int getTotalSequencedPointsForString(WidgetStringedInstrumentString *string) {
        int sequencedPoints = 0;
        for(WidgetStringedInstrumentPoint point:getFretPointsForString(string)) {
            if (point.sequenceNumber > 0) {
                sequencedPoints++;
            }
        }
    ...
    void addPoints(vector<WidgetStringedInstrumentPoint> points)
    {
        mPoints = points;
        ...
        for (int s = 0; s < getStrings().size(); s++)
        {
            ...
            vector<WidgetStringedInstrumentPoint> fretPoints = getFretPointsForString(currString);
    ...
    int getNumPointsOnString(WidgetStringedInstrumentString *string, bool includeSequencedNotes)
    {
    ...
    bool addPoint(WidgetStringedInstrumentPoint point)
    {
        ...
        for (int i = 0; i < getPoints().size(); i++)
        {
            WidgetStringedInstrumentPoint currExistingPoint = getPoints()[i];
    ...
    void clearPoints()
    {
        mPoints = vector<WidgetStringedInstrumentPoint>();
    }
    ...
    string getTuningNoteNames(vector<WidgetStringedInstrumentString> strings, bool includeOctaves)
    {
        string tmp = "";
        if (getStrings().size() > 0)
        {
    ...
    Widget *getPopoutWidgetForMenuTag(int menuTag) override
    {
        ...
        case Aquamarine::IconCache::IconTag::WIDGET_SETTINGS_MINI:
    ...
    void onWidgetMousePressed(ofMouseEventArgs &e) override
    {
        if (e.button == OF_MOUSE_BUTTON_RIGHT && getUserCanInvokeContextMenu())
        {
            ...
            /*
            Widget* w = getPopoutWidgetForMenuTag(IconCache::IconTag::WIDGET_SETTINGS);
...
*/
    ...
    virtual vector<vector<WidgetStringedInstrumentString>> getTunings()
    {

        return {};
    }

    virtual vector<Aquamarine::WidgetMenuItem> getTuningsMenuItems()
    {

        vector<Aquamarine::WidgetMenuItem> tuningsMenuItems = {};
        vector<vector<WidgetStringedInstrumentString>> tunings = getTunings();

        for (int i = 0; i < tunings.size(); i++)
        {
            if (i == 0) {
                tuningsMenuItems.push_back(
                    Aquamarine::WidgetMenuItem("Custom...", -1, false, false)
                );
            }

            vector<WidgetStringedInstrumentString> strings = tunings[i];

            if (strings.size() > 0)
            {
                tuningsMenuItems.push_back(
                    Aquamarine::WidgetMenuItem(strings[0].note.getNoteTagsString("|") + " (" + getTuningNoteNames(strings, true) + ")", strings[0].note.getNoteTagsString("|"), i, false, i == 0));
            }
        }
    ...
    virtual vector<Aquamarine::WidgetMenuItem> getStringsMenuItems()
    {

        vector<Aquamarine::WidgetMenuItem> stringsMenuItems = {};
        vector<WidgetStringedInstrumentString> strings = getStrings();

        for (int i = 0; i < strings.size(); i++)
        {
            stringsMenuItems.push_back(
                Aquamarine::WidgetMenuItem(strings[i].note.getNoteName() + " string", i, true, strings[i].isEnabled));
        }
        return stringsMenuItems;
    }

    virtual vector<Aquamarine::WidgetMenuItem> getStartFretMenuItems()
    {

        vector<Aquamarine::WidgetMenuItem> fretItems = {};

        for (int i = 0; i <= mTotalFrets; i++)
        {
            fretItems.push_back(
                Aquamarine::WidgetMenuItem("Fret " + ofToString(i), i, false, i == 0));
        }
        return fretItems;
    }

    virtual vector<Aquamarine::WidgetMenuItem> getEndFretMenuItems()
    {
    ...
    {
        WidgetMusical::setUserDefinedChordName(val);
    ...
    void addSelectedChord(vizChord &chord, bool onlyAddIfNotFound, bool includeInstrumentRules, bool updateChordDesignerMenuItem)
    {
        ...
        WidgetMusical::addSelectedChord(chord, onlyAddIfNotFound, includeInstrumentRules);
        vector<WidgetStringedInstrumentString> ruleStrings = getStringsFromRules(chord);
    ...
    virtual void setSelectedScale(vizScale scale, bool includeInstrumentRules) override
    {
        ...
        WidgetMusical::setSelectedScale(scale, includeInstrumentRules);
        vector<WidgetStringedInstrumentString> ruleStrings = getStringsFromRules(scale);
    ...
    void initMenu()
    {
        ...
        if (!GUIT_DIALOG) {
           ...
           GUIT_DIALOG = new Aquamarine::WidgetDialog("GUIT_DIALOG_" + ofToUpper(getWidgetId()), R"(
                <widget>
                    <bounds width="500" height="300" />
                </widget>
                )");           

             Aquamarine::WidgetManager::addWidgetForPopout(*GUIT_DIALOG, getWidgetId(), false);

        }    

        if (!NOTES_TABLE) {

           NOTES_TABLE = new WidgetNotesTable("NOTES_TABLE_" + ofToUpper(getWidgetId()), R"(
                <widget>
                    <bounds width="500" height="300" />
                </widget>
                )");
            ...
            Aquamarine::WidgetManager::addWidgetForPopout(*NOTES_TABLE, getWidgetId(), true);
        }        
        ...
        if (!instrumentContextMenu)
        {
            ...
            ofAddListener(keyPickerMenuItem->keySelected, this, &WidgetStringedInstrument::onKeyPickerMenuKeySelected);
            ...
            */
            ...
            chordWheelMenuItem = new WidgetChordWheel(
            ...
            buttonOpenVariations = dynamic_cast<Aquamarine::WidgetElmButton *>(chordDesignerMenuItem->addOrLoadWidgetElement(buttonOpenVariations, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "ARROW_UP", R"(
                <element>
            ...
            buttonOpenSettings = dynamic_cast<Aquamarine::WidgetElmButton *>(chordDesignerMenuItem->addOrLoadWidgetElement(buttonOpenSettings, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "ARROW_SETTINGS", R"(
                <element>
            ...
            buttonOpenSettings->handlePressed([this]() {
                Aquamarine::WidgetMenu* menu = dynamic_cast<Aquamarine::WidgetMenu*>(chordDesignerMenuItem->getPopoutWidgetForMenuTag(Aquamarine::IconCache::IconTag::WIDGET_SETTINGS));
            ...
            buttonOpenVariations->handlePressed([this]() {
                ...
                string widgetPersistentId = Aquamarine::WidgetManager::getSuggestedNewWidgetPersistentId(APP_CONSTANTS::WIDGET_CLASS_CHORD_BUCKET);
                chordBucket = dynamic_cast<WidgetMusical*>(Aquamarine::WidgetManager::loadWidget(APP_CONSTANTS::WIDGET_CLASS_CHORD_BUCKET, widgetPersistentId, R"(
                ...
                Aquamarine::WidgetManager::addWidget(*chordBucket, true);
                Aquamarine::WidgetManager::centerWidget(chordBucket);
                ...
                vector<WidgetStringedInstrumentString> ruleStrings;
                vector<WidgetStringedInstrumentString> prev_ruleStrings;
...
// new widget -> give it a chord and it gives variations eg Em -> Em7 Emsus etc
            ...
            ofAddListener(chordDesignerMenuItem->rulesChanged, this, &WidgetStringedInstrument::onRulesChanged);
            ofAddListener(chordDesignerMenuItem->noteSelected, this, &WidgetStringedInstrument::onChordDesignerMenuNoteSelected);
            ofAddListener(chordDesignerMenuItem->userDefinedChordNameChanged, this, &WidgetStringedInstrument::onUserDefinedChordNameChanged);

            scalePickerMenuItem = new WidgetScalePicker(
                getWidgetId() + "_MENU_SCALE_PICKER",
                "<widget><bounds minWidth='100' minHeight='100' width='300' height='300'/><appearance lockAspectRatio='1' aspectRatio='1'/></widget>");
            ofAddListener(scalePickerMenuItem->rulesChanged, this, &WidgetStringedInstrument::onRulesChanged);
            ofAddListener(scalePickerMenuItem->noteSelected, this, &WidgetStringedInstrument::onScalePickerMenuNoteSelected);


            buttonOpenSettingsScale = dynamic_cast<Aquamarine::WidgetElmButton *>(scalePickerMenuItem->addOrLoadWidgetElement(buttonOpenSettingsScale, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "ARROW_SETTINGS", R"(
                <element>
                <bounds width="27" height="27" xExpr="${PARENT.RIGHT}" yExpr="${PARENT.BOTTOM}" />
                <properties icon="MED_CONTENT_SETTINGS"/>
                </element>
            ...
            buttonOpenSettingsScale->handlePressed([this]() {
                Aquamarine::WidgetMenu* menu = dynamic_cast<Aquamarine::WidgetMenu*>(scalePickerMenuItem->getPopoutWidgetForMenuTag(Aquamarine::IconCache::IconTag::WIDGET_SETTINGS));
                menu->popoutFrom(buttonOpenSettingsScale, PopoutDirection::UP, false); 
            });            

            instrumentContextMenu = new Aquamarine::WidgetMenu(menuId, "<widget><bounds width='100' height='300'/></widget>", getWidgetId(),
            ...
            // Octave mode menu
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("OCTAVE"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_THEORY_OCTAVE_MODE, {
                Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("NONE"), 0, false, true), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("SHOW_OCTAVE"), 1)
                //Aquamarine::WidgetMenuItem("Scale", (int)TheoryVizColorMode::SCALES)
            }),
            ...
            // Tunings menu
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("TUNINGS"), Aquamarine::IconCache::getIcon("MED_CONTENT_SETTINGS"), MENU_GROUP_1::MENU_TAB_TUNINGS, getTuningsMenuItems()),

            // ----------------------------------------------------------------------------
            // Start Fret menu
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("START_FRET"), Aquamarine::IconCache::getIcon("MED_CONTENT_SETTINGS"), MENU_GROUP_1::MENU_TAB_START_FRET, getStartFretMenuItems()),

            // ----------------------------------------------------------------------------
            // End Fret menu
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("END_FRET"), Aquamarine::IconCache::getIcon("MED_CONTENT_SETTINGS"), MENU_GROUP_1::MENU_TAB_END_FRET, getEndFretMenuItems()),

            // ----------------------------------------------------------------------------
            // Strings menu
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("STRINGS"), Aquamarine::IconCache::getIcon("MED_CONTENT_SETTINGS"), MENU_GROUP_1::MENU_TAB_STRINGS, getStringsMenuItems()),

            // ----------------------------------------------------------------------------
            // Chord view mode
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("CHORD_VIEW"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_CHORD_VIEW_MODE, {Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("REGULAR"), (int)TheoryVizInstrumentChordViewMode::UNSET), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("STRINGED_CHORD_DIAGRAM") + " " + ofToString(3), 3), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("STRINGED_CHORD_DIAGRAM") + " " + ofToString(4), 4), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("STRINGED_CHORD_DIAGRAM") + " " + ofToString(5), 5), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("STRINGED_CHORD_DIAGRAM") + " " + ofToString(6), 6)}),

            // ----------------------------------------------------------------------------
            // Settings menu
            // ----------------------------------------------------------------------------
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("SETTINGS"), Aquamarine::IconCache::getIcon("MED_CONTENT_SETTINGS"), MENU_GROUP_1::MENU_TAB_SETTINGS, {Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("SOUND"), 1, true, true), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("LEFT_HAND"), 2, true, false), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("FLIP_ORIENTATION"), 3, true, false), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("SWITCH_VIEW"), 4, true, false), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("EXPORT_PNG"), 5), Aquamarine::WidgetMenuItem(Aquamarine::Shared::lang("EXPORT_XML"), 6)}),

            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("EVENT_LISTENER"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_SETTINGS, getWidgetEventListenerConfig()), 
            Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("EVENT_LISTENER"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_SETTINGS, WidgetMusicalHelper::getWidgetEventListenerMusicalConfig(this)) // OR DO WE NEED ?? instrumentContextMenu

            // ----------------------------------------------------------------------------
            // Key Picker menu
            // ----------------------------------------------------------------------------
            // Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("KEY_PICKER"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_KEY_PICKER, keyPickerMenuItem)//,

            // ----------------------------------------------------------------------------
            // Chord Wheel menu
            // ----------------------------------------------------------------------------
            // Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("CHORD_WHEEL"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_CHORD_WHEEL, chordWheelMenuItem),

            // ----------------------------------------------------------------------------
            // Chord Designer menu
            // ----------------------------------------------------------------------------
            //Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("CHORD_DESIGNER"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_CHORD_DESIGNER, chordDesignerMenuItem),

            // ----------------------------------------------------------------------------
            // Scale Designer menu
            // ----------------------------------------------------------------------------
            //Aquamarine::WidgetMenuTab(Aquamarine::Shared::lang("SCALE_PICKER"), Aquamarine::IconCache::getIcon("MED_CONTENT_THEORY_LABEL"), MENU_GROUP_1::MENU_TAB_SCALE_PICKER, scalePickerMenuItem)

            });

            ofAddListener(dynamic_cast<Aquamarine::WidgetMenu *>(instrumentContextMenu)->menuItemSelected, this, &WidgetStringedInstrument::onMenuItemSelected);


            // Mini menu -------------------------------------------------

            instrumentContextMenuMini = new Aquamarine::WidgetMenu(menuId+"_mini", "<widget><bounds width='100' height='300'/></widget>", getWidgetId(),
            Aquamarine::WidgetMenu::PreferredPopoutDirection::DOWN, {
            ...
            ofAddListener(dynamic_cast<Aquamarine::WidgetMenu *>(instrumentContextMenuMini)->menuItemSelected, this, &WidgetStringedInstrument::onMenuItemSelected);


            Widget* chordMenu = chordDesignerMenuItem->getPopoutWidgetForMenuTag((int)Aquamarine::IconCache::IconTag::WIDGET_SETTINGS);
            if (chordMenu) {
            ...
            Aquamarine::WidgetManager::addWidget(*instrumentContextMenu, false, getWidgetId());
            Aquamarine::WidgetManager::addWidget(*instrumentContextMenuMini, false, getWidgetId());
    ...
    void setStartFret(int val, bool storePriorVal, bool purgeOutOfRangePoints)
    {
        ...
        {
            vector<WidgetStringedInstrumentPoint> inBoundsPoints;
    ...
    {
        WidgetMusical::onWidgetEventReceived(args);
...
private:
    ...
    WidgetNotesTable* getNoteTable() {
        return NOTES_TABLE;
    }

    Widget *instrumentContextMenu = nullptr;
    Widget *instrumentContextMenuMini = nullptr;
    
    WidgetKeyPicker *keyPickerMenuItem = nullptr;
    WidgetChordWheel *chordWheelMenuItem = nullptr;
    WidgetChordDesigner *chordDesignerMenuItem = nullptr;
    WidgetScalePicker *scalePickerMenuItem = nullptr;

    Aquamarine::Elm fretboard;
    Aquamarine::Elm nut;
    ...
    Aquamarine::WidgetDialog* GUIT_DIALOG = nullptr;   
    WidgetNotesTable* NOTES_TABLE = nullptr;  
    WidgetMusical* chordBucket = nullptr;  
    ...
    Aquamarine::WidgetElmTextbox *userDefinedChordName = nullptr;
    Aquamarine::WidgetElmButton *buttonDown = nullptr;
    Aquamarine::WidgetElmButton *buttonUp = nullptr;
    Aquamarine::WidgetElmButton *buttonChordSettings = nullptr;

    Aquamarine::WidgetElmButton *buttonPlay = nullptr;    
    Aquamarine::WidgetElmButton *buttonOpenVariations = nullptr;   
    Aquamarine::WidgetElmButton *buttonOpenSettings = nullptr;   
    Aquamarine::WidgetElmButton *buttonOpenSettingsScale = nullptr;   
    ...
    vector<WidgetStringedInstrumentString> mStrings = {};
    vector<WidgetStringedInstrumentPoint> mPoints = {};
    vector<WidgetStringedInstrumentFret> mFrets{};
    ...
    void onMenuItemSelected(Aquamarine::WidgetMenuItemArgs &args)
    {
        ...
        case MENU_GROUP_1::MENU_TAB_TUNINGS:
        {
            ...
            if (args.menuItem->uniqueID == -1) {
                    ...
                    GUIT_DIALOG->showDialog(
                        ...
                        "BTN_OK",
                        false,
                        [&, this](Aquamarine::WidgetEventArgs args) {
                            if (args.widgetId == "BTN_OK") {

                                vector<WidgetStringedInstrumentString> defaultTuning = this->getTunings()[0]; // Use this for string widths...


                                vector<WidgetStringedInstrumentString> customTuning;
                                ...
                                for(int i=0; i<defaultTuning.size(); i++) {
                                    ...
                                    customTuning.push_back(WidgetStringedInstrumentString(n, stringThickness[i]));
                                }
                    ...
                    vector<WidgetStringedInstrumentString> defaultTuning = getStrings();
                    string lastId = "";
                    ...
                    for(int i=0; i<defaultTuning.size(); i++) {
                        ...
                        Aquamarine::WidgetElmButton *b = dynamic_cast<Aquamarine::WidgetElmButton*>(GUIT_DIALOG->addOrLoadWidgetElement(nullptr, Aquamarine::WIDGET_ELM_CLASS::BUTTON, buttonId, R"(
                            <element>
                            </element>
                            )"));
                        ...
                        b->setPopoutWidgetClosedCallback([&](WidgetBase* sender, WidgetBase* closedWidget, const string s) {
                            WidgetNotesTable *notesTable = static_cast<WidgetNotesTable *>(closedWidget);
                            Aquamarine::WidgetElmButton *button = static_cast<Aquamarine::WidgetElmButton *>(sender);

                            vector<WidgetStringedInstrumentString> currentStrings = getStrings();                            
        ...
        case MENU_GROUP_1::MENU_TAB_SETTINGS:
            ...
            else if (args.menuItem->uniqueID == 5)
            {
                ...
                Aquamarine::WidgetManager::showSaveDialog("", vizTheory::extractFileSystemSafeName(getTitle() + ".png"),
                                                   [&](string filePath)
                                                   {
            ...
            {
                // SAVE AS XML ...
                Aquamarine::WidgetManager::showSaveDialog("", vizTheory::extractFileSystemSafeName(getTitle() + ".xml"),
                                                   [&](string filePath)
                                                   {
    ...
    void onWidgetHovered(Aquamarine::WidgetEventArgs &args) override
    {
    ...
    void initWidget() override
    {
        ...
        setTitleStyle(Widget::TitleStyle::TOP_OVERLAY);
        ...
        buttonDown = dynamic_cast<Aquamarine::WidgetElmButton *>(addOrLoadWidgetElement(buttonDown, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "ARROW_DOWN", R"(
            <element>
        ...
        buttonUp = dynamic_cast<Aquamarine::WidgetElmButton *>(addOrLoadWidgetElement(buttonUp, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "ARROW_UP", R"(
            <element>
            <bounds width="27" height="27" />
            <properties icon="MED_CONTENT_ARROW_UP"/>
            </element>
        ...
        buttonPlay = dynamic_cast<Aquamarine::WidgetElmButton *>(addOrLoadWidgetElement(buttonPlay, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "BUTTON_PLAY", R"(
            <element>
            <bounds width="27" height="27" />
        ...
        buttonChordSettings = dynamic_cast<Aquamarine::WidgetElmButton *>(addOrLoadWidgetElement(buttonChordSettings, Aquamarine::WIDGET_ELM_CLASS::BUTTON, "ARROW_SETTINGS", R"(
            <element>
            <bounds width="27" height="27" xExpr="${PARENT.RIGHT}" yExpr="${PARENT.BOTTOM}" />
            <properties icon="MED_CONTENT_SETTINGS"/>
            </element>
        ...
        buttonChordSettings->handlePressed([this]() {
            Aquamarine::WidgetMenu *menuMini = static_cast<Aquamarine::WidgetMenu *>(instrumentContextMenuMini);
            if(menuMini) {
                showContextMenu(Aquamarine::IconCache::IconTag::WIDGET_SETTINGS_MINI, deScale(ofGetMouseX()) - 20, deScale(ofGetMouseY()) - 20);
            }
        });
