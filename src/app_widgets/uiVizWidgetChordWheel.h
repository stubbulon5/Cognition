...
class uiVizWidgetChordWheelSlice {
public:
    vizChord chord;
...
class uiVizWidgetChordWheel : public uiVizWidgetMusical {

public:
   
    uiVizWidgetChordWheel(string persistentId, string widgetXML) : uiVizWidgetMusical(persistentId, widgetXML) {
        initWidget();
        loadState(widgetXML);
    }
    ...
    void setSliceProperties(uiVizWidgetChordWheelSlice *slice,
    ...
    void update(Aquamarine::uiVizWidgetContext context) override {
        ...
        for (int i = 1; i <= circleSlicesT1.size() ; i++) {
            ...
            uiVizWidgetChordWheelSlice *sliceT1 = &circleSlicesT1[i-1];
            ...
            for (int j = i*2-1; j <= i*2 ; j++) {
                ...
                uiVizWidgetChordWheelSlice *sliceT2 = &circleSlicesT2[j-1];
            ...
            uiVizWidgetChordWheelSlice *sliceT3 = &circleSlicesT3[i-1];
        ...
        for (int i=T1Alternator; i<=12; i=i+3) {
            ...
            if (getSelectedChordsSize() == 0 || (getSelectedChordsSize() > 0 && (isSelectedChordRoot(curKey)))) {
                ...
                uiVizWidgetChordWheelSlice *sliceT1_I = &circleSlicesT1[keyIndex];
                ...
                uiVizWidgetChordWheelSlice *sliceT1_V = &circleSlicesT1[nextKeyIndex];
                ...
                uiVizWidgetChordWheelSlice *sliceT1_IV = &circleSlicesT1[prevKeyIndex];
                ...
                uiVizWidgetChordWheelSlice *sliceT2_II = &circleSlicesT2[j-1];
                ...
                uiVizWidgetChordWheelSlice *sliceT2_III = &circleSlicesT2[nextKeyIndex2-1];
                ...
                uiVizWidgetChordWheelSlice *sliceT2_VI = &circleSlicesT2[nextKeyIndex3-1];
                ...
                // T3 -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
                uiVizWidgetChordWheelSlice *sliceT3_VII = &circleSlicesT3[keyIndex];
    ...
    void drawSlice(int tier, int currentSlice, uiVizWidgetChordWheelSlice &slice) {
...
private:
    ...
    vector<uiVizWidgetChordWheelSlice> circleSlicesT1;
    vector<uiVizWidgetChordWheelSlice> circleSlicesT2;
    vector<uiVizWidgetChordWheelSlice> circleSlicesT3;
    ...
    void initScale() {
        ...
        for (int key=0; key<chordMatrixCurrent.size(); key++) {
            ...
            uiVizWidgetChordWheelSlice sliceT1_I, sliceT2_II, sliceT2_III, sliceT3_VII;
        ...
        if (!chordWheelContextMenu) {
            ...
            chordWheelContextMenu = new Aquamarine::uiVizWidgetMenu(getWidgetId() + "_CP_MENU1", "<widget><bounds width='100' height='300'/></widget>", getWidgetId()
               ...
               // ----------------------------------------------------------------------------
                // Chord Designer menu
                // ----------------------------------------------------------------------------
                Aquamarine::uiVizWidgetMenuTab(Aquamarine::Shared::lang("CHORD_DESIGNER"), Aquamarine::uiVizIconCache::getIcon("MED_CONTENT_THEORY_LABEL"),
            ...
            ofAddListener(dynamic_cast<Aquamarine::uiVizWidgetMenu*>(chordWheelContextMenu)->menuItemSelected, this, &uiVizWidgetChordWheel::onMenuItemSelected);
    ...
    ofColor getLabelStateColor(uiVizWidgetChordWheelSlice slice) {
        if (slice.isHovered)  {
