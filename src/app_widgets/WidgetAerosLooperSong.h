...
class WidgetAerosLooperSong : public Widget {
    
public:
    
    WidgetAerosLooperSong(string persistentId, string widgetXML) : Widget(persistentId, widgetXML) {
        initWidget();
        loadState(widgetXML);
    }
    ...
    virtual ~WidgetAerosLooperSong() {


        ofRemoveListener(TBL_NUMBER_PICKER->cellSelected, this,  &WidgetAerosLooperSong::onNumberMenuCellCelected);
    ...
    void onNumberMenuCellCelected(WidgetTableArgs &args) {
...
/*
    ...
    virtual void onChildWidgetsLoaded() override {
        ...
        if (!hookedEvents) {
            ...
            ofAddListener(TOOL_TABS->menuItemSelected, this, &WidgetAerosLooperSong::onToolTabsMenuItemSelected);
            ...
            ofAddListener(TBL_NUMBER_PICKER->cellSelected, this,  &WidgetAerosLooperSong::onNumberMenuCellCelected);


            TBL_NUMBER_PICKER->setWidgetClosedCallback([this](WidgetBase* sender, WidgetBase* closedWidget, string result) {
    ...
    void setNumElmVal(WidgetBase* elm, int val) {
    ...
    WidgetTable* getTBL_NUMBER_PICKER() {
...
private:
    ...
    Widget* SONG_INFO_HOLDER = nullptr;


    WidgetElmLabel* LBL_SONG_TITLE = nullptr;
    WidgetElmTextbox* TXT_TITLE = nullptr;
    WidgetElmLabel* LBL_2X2_ENABLED = nullptr;
    WidgetElmCheckbox* MODE_2X2_ENABLED = nullptr;
    WidgetElmLabel* LBL_STEREO = nullptr;
    WidgetElmCheckbox* STEREO = nullptr;
    WidgetElmLabel* LBL_TIME_SIG = nullptr;
    WidgetElmButton* BTN_TIME_SIGNATURE_NUMERATOR = nullptr;
    WidgetElmButton* BTN_TIME_SIGNATURE_DENOMINATOR = nullptr;
    WidgetElmButton* BTN_BPM = nullptr;
    WidgetElmLabel* LBL_RECORDING_OPTIONS = nullptr;
    WidgetElmButton* BTN_COUNT_IN = nullptr;
    WidgetElmButton* BTN_SYNC_TRACKS_OPTION = nullptr;
    WidgetElmLabel* LBL_QUANTIZE = nullptr;
    WidgetElmCheckbox* QUANTIZE_TRACK_ENABLED = nullptr;
    WidgetElmLabel* LBL_MIDI_OPTIONS = nullptr;
    WidgetElmButton* BTN_MIDI_BANK_MSB = nullptr;
    WidgetElmButton* BTN_MIDI_PROGRAM_NUMBER = nullptr;
    WidgetElmCheckbox* CHK_MIDI_SELECT_ENABLED = nullptr;

    Singul::Song loadedSong;

    WidgetTable* TBL_NUMBER_PICKER = nullptr;
    ...
    void initWidget() override {
        ...
        if (!TBL_NUMBER_PICKER) {
           TBL_NUMBER_PICKER = new WidgetTable("TBL_NUMBER_PICKER", R"(
                <widget>
