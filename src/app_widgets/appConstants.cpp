...
const string APP_CONSTANTS::APPLICATION_WEBSITE = "https://www.cognitionviz.com";

const string APP_CONSTANTS::DEFAULT_LANGUAGE_XML = ""
...
const string APP_CONSTANTS::WIDGET_CLASS = "Widget";
const string APP_CONSTANTS::WIDGET_CLASS_MUSICAL = "WidgetMusical";
const string APP_CONSTANTS::WIDGET_CLASS_EVENT_LISTENER_MUSICAL = "WidgetEventListenerMusical";
const string APP_CONSTANTS::WIDGET_CLASS_MUSICAL_COMPOSER = "WidgetMusicalComposer";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_WHEEL = "WidgetChordWheel";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_WHEEL_FOR_KEY = "WidgetChordWheelForKey";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_PROGRESSION = "WidgetChordProgression";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_BUCKET = "WidgetChordBucket";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_BUCKET_SUGGESTER = "WidgetChordBucketSuggester";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_DESIGNER = "WidgetChordDesigner";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_RULES = "WidgetChordRules";
const string APP_CONSTANTS::WIDGET_CLASS_SCALE_PICKER = "WidgetScalePicker";
const string APP_CONSTANTS::WIDGET_CLASS_SCALE_TABLE = "WidgetScaleTable";
const string APP_CONSTANTS::WIDGET_CLASS_CHORD_TABLE = "WidgetChordTable";
const string APP_CONSTANTS::WIDGET_CLASS_NOTES_TABLE = "WidgetNotesTable";
const string APP_CONSTANTS::WIDGET_CLASS_KEY_PICKER = "WidgetKeyPicker";
const string APP_CONSTANTS::WIDGET_CLASS_KEY_PICKER_POPOUT = "WidgetKeyPickerPopout";
const string APP_CONSTANTS::WIDGET_CLASS_STRINGED_INSTRUMENT = "WidgetStringedInstrument";
const string APP_CONSTANTS::WIDGET_CLASS_GUITAR = "WidgetGuitar";
const string APP_CONSTANTS::WIDGET_CLASS_BASS_GUITAR = "WidgetBassGuitar";
const string APP_CONSTANTS::WIDGET_CLASS_TUTOR = "WidgetTutor";
const string APP_CONSTANTS::WIDGET_CLASS_ABOUT = "WidgetAbout";
const string APP_CONSTANTS::WIDGET_CLASS_UNIT_TESTS = "WidgetUnitTests";
const string APP_CONSTANTS::WIDGET_CLASS_MAIN_MENU = "WidgetMainMenu";
const string APP_CONSTANTS::WIDGET_CLASS_OMNI_MENU = "WidgetOmniMenu";
const string APP_CONSTANTS::WIDGET_CLASS_OMNI_MENU_SEARCH_RESULTS = "WidgetOmniMenuSearchResults";
const string APP_CONSTANTS::WIDGET_CLASS_OMNI_MENU_LINKS = "WidgetOmniMenuLinks";
const string APP_CONSTANTS::WIDGET_CLASS_LICENCE = "WidgetLicence";
const string APP_CONSTANTS::WIDGET_CLASS_GET_STARTED = "WidgetGetStarted";
const string APP_CONSTANTS::WIDGET_CLASS_NOTIFICATIONS = "WidgetNotifications";
const string APP_CONSTANTS::WIDGET_CLASS_TEXT_EDITOR = "WidgetTextEditor";
...
// template <typename T>
// Aquamarine::Widget *createWidget(string persistentId, string widgetXML) { return new T(persistentId, widgetXML); }
// typedef map<string, Aquamarine::Widget *(*)(string persistentId, string widgetXML)> widget_map_type;

/*
Aquamarine::WidgetLibrary::widget_map_type APP_CONSTANTS::getAppWidgetMap() {

    Aquamarine::WidgetLibrary::widget_map_type appWidgetMap;
...
std::function<void()> APP_CONSTANTS::registerCustomWidgets()
{
    return [&]() {
        
        // Aquamarine::WidgetLibrary::registerWidgetType<Aquamarine::Widget>("Widget");
      
      
    //    Aquamarine::WidgetLibrary::registerWidgetType<WidgetMusical>("WidgetMusical");


        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetEventListenerMusical>("WidgetEventListenerMusical");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetMusicalComposer>("WidgetMusicalComposer");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordWheel>("WidgetChordWheel");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordWheelForKey>("WidgetChordWheelForKey");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordProgression>("WidgetChordProgression");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordBucket>("WidgetChordBucket");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordBucketSuggester>("WidgetChordBucketSuggester");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordDesigner>("WidgetChordDesigner");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordRules>("WidgetChordRules");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetScalePicker>("WidgetScalePicker");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetScaleTable>("WidgetScaleTable");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetChordTable>("WidgetChordTable");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetNotesTable>("WidgetNotesTable");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetKeyPicker>("WidgetKeyPicker");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetKeyPickerPopout>("WidgetKeyPickerPopout");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetStringedInstrument>("WidgetStringedInstrument");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetGuitar>("WidgetGuitar");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetBassGuitar>("WidgetBassGuitar");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetTutor>("WidgetTutor");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetAbout>("WidgetAbout");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetUnitTests>("WidgetUnitTests");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetMainMenu>("WidgetMainMenu");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetOmniMenu>("WidgetOmniMenu");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetOmniMenuSearchResults>("WidgetOmniMenuSearchResults");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetOmniMenuLinks>("WidgetOmniMenuLinks");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetLicence>("WidgetLicence");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetGetStarted>("WidgetGetStarted");
        // Aquamarine::WidgetLibrary::registerWidgetType<WidgetNotifications>("WidgetNotifications");


    };
}

map<string, Aquamarine::Icon *> APP_CONSTANTS::getIconCacheMap(float scale)
{
...
const string APP_WIDGET_EVENT::SET_SELECTED_KEY = "set_selected_key";
const string APP_WIDGET_EVENT::ADD_SELECTED_CHORD = "add_selected_chord";
const string APP_WIDGET_EVENT::ADD_SELECTED_NOTE = "add_selected_note";
const string APP_WIDGET_EVENT::SET_SELECTED_SCALE = "set_selected_scale";
const string APP_WIDGET_EVENT::SET_HOVERED_CHORD = "set_hovered_chord";

#ifdef TARGET_OF_IOS
string mIOSGetDocumentsDirectory = "";
void APP_CONSTANTS::setIOSGetDocumentsDirectory(string val)
{
    mIOSGetDocumentsDirectory = val;
}
string APP_CONSTANTS::getIOSGetDocumentsDirectory()
{
