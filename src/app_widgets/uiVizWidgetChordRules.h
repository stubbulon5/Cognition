...
class uiVizWidgetChordRules : public uiVizWidgetMusical {
public:

    ofEvent<uiVizInstrumentRuleArgs>     rulesChanged;

    uiVizWidgetChordRules(string persistentId, string widgetXML) : uiVizWidgetMusical(persistentId, widgetXML) {
        initWidget();
        loadState(widgetXML);
    }
    ...
    void addSelectedChord(vizChord &chord, bool onlyAddIfNotFound, bool includeInstrumentRules) override {
        ...
        clearSelectedNotes();
        uiVizWidgetMusical::setSelectedKey(chord.getChordRootNote());
...
*/
    ...
    virtual void setTheoryVizInstrumentTheoryContentMode(TheoryVizInstrumentTheoryContentMode theoryVizInstrumentTheoryContentMode) override {
        uiVizWidgetMusical::setTheoryVizInstrumentTheoryContentMode(theoryVizInstrumentTheoryContentMode);
