...
public:
    struct ApplicationProperties {
        ...
        ApplicationProperties(string applicationName, string applicationVersion, string fileExtension) :
        applicationName(applicationName), applicationVersion(applicationVersion), fileExtension(fileExtension) {};
    };
    ...
    struct ProjectProperties {
        ...
        string fileName = "";
        bool isDirty = false;
        ProjectProperties(string projectName, string absolutePath, string path, string fileName) :
        projectName(projectName), absolutePath(absolutePath), path(path), fileName(fileName) {};
    };
