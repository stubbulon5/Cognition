...
public:
    ...
    virtual void afterLoad(ofxXmlSettings settings) { // Override in descendant for after load hook
    }
    ...
    virtual void beforeSave(ofxXmlSettings settings) { // Override in descendant for save hook
    }
...
private:
    ...
    void initWidget() override {
        ...
        settingsMenu = new uiVizWidgetMenu("APP_SETTINGS_MENU", "<widget><bounds width='100' height='100'/></widget>", getWidgetId()
            , uiVizWidgetMenu::PreferredPopoutDirection::DOWN, {
                ...
                uiVizWidgetMenuTab("Color", uiVizIconCache::getIcon("MED_CONTENT_THEORY_COLOR"), uiVizIconCache::IconTag::WIDGET_THEMES, {
                    getThemesMenuItems()
                })
