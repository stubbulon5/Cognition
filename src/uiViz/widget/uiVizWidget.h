...
struct uiVizWidgetCacheData {
    ...
    uiVizWidgetCacheData(string imagePath, string widgetClassName, string widgetPrettyName) :
        imagePath(imagePath), widgetClassName(widgetClassName), widgetPrettyName(widgetPrettyName) {};
};
...
struct uiVizWidgetSignature {
    ...
    uiVizWidgetSignature(string persistentId, string widgetClass, string widgetXML) :
        persistentId(persistentId), widgetClass(widgetClass), widgetXML(widgetXML) {};    
...
public:
    ...
    uiVizWidgetEventArgs(string eventSenderId, string eventName, ofxXmlSettings eventXML, uiVizWidgetBase& sender) :
        widgetId(eventSenderId), eventName(eventName), eventXML(eventXML), sender(sender) {}

    uiVizWidgetEventArgs(string eventSenderId, string eventName, ofxXmlSettings eventXML, uiVizWidgetBase& sender, uiVizWidgetBase* target) :
        widgetId(eventSenderId), eventName(eventName), eventXML(eventXML), sender(sender), target(target) {}
