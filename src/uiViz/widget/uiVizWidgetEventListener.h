...
public:
    ...
    virtual void draw(uiVizWidgetContext context) override {
        if(btnAdd != nullptr) btnAdd->setIsVisible(tabs->getSelectedTag() == "LISTENER_CONFIG");
    }
        ...
        if (!loaded) {
            ...
            uiVizWidgetMenu::PreferredPopoutDirection::DOWN, {
                uiVizWidgetMenuTab(uiVizShared::lang("SETTINGS"), uiVizIconCache::getIcon("MED_CONTENT_SETTINGS"), MENU_GROUP_1::MENU_TAB_SETTINGS, {
                    uiVizWidgetMenuItem(uiVizShared::lang("SOUND"), 1, true, true), uiVizWidgetMenuItem(uiVizShared::lang("LEFT_HAND"), 2, true, false), 
                    uiVizWidgetMenuItem(uiVizShared::lang("FLIP_ORIENTATION"), 3, true, false), 
                    uiVizWidgetMenuItem(uiVizShared::lang("SWITCH_VIEW"), 4, true, false), 
                    uiVizWidgetMenuItem(uiVizShared::lang("EXPORT_PNG"), 5), 
                    uiVizWidgetMenuItem(uiVizShared::lang("EXPORT_XML"), 6)
                })
           ...
           tabs = new uiVizWidgetMenuCollection("TABS", R"(
            ...
            tabs->setTabMenuCollection(this, {
                uiVizWidgetMenuCollectionItem("SETTINGS", contextMenu, "Settings", uiVizIconCache::getIcon("REG_BUG")),                
