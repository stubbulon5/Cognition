...
public:
    ...
    virtual bool loadState(string widgetXML) override {
        ...
        if (getLoadedWidgetsDisplayMode()) {
            ...
            headerRow = uiVizWidgetTableRow("Header", {
                uiVizWidgetTableCell("widget", "Widget Id", 300),
            ...
            for(uiVizWidget &widget:uiVizWidgetManager::getWidgets()) {
                ...
                if (found || getAllowedWidgetClassTypes().size() == 0) {
                    tableRows.push_back(
                        uiVizWidgetTableRow(widget.getWidgetId(), {
                            uiVizWidgetTableCell(widget.getPersistentId(), widget.getPersistentId()),
            ...
            headerRow = uiVizWidgetTableRow("Header", {
                uiVizWidgetTableCell("widget", "Widget", 300),
                uiVizWidgetTableCell("type", "Type")
            });
            ...
            for (auto it = widgetMap.begin(); it != widgetMap.end(); it++) {
                ...
                if (widgetName == "") widgetName = "Widget"; 
                ...
                if (found || getAllowedWidgetClassTypes().size() == 0) {
                    tableRows.push_back(
                        uiVizWidgetTableRow(widgetClass, {
                            uiVizWidgetTableCell("", widgetName),
            ...
            for (auto it = elmClassMapTemp.begin(); it != elmClassMapTemp.end(); it++) {
                ...
                if (elementName == "") elementName = "Element"; 
                    ...
                    tableRows.push_back(
                        uiVizWidgetTableRow(elementClass, {
                            uiVizWidgetTableCell("", elementName, 300),
