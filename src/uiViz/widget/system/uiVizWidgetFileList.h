...
*/
            ...
            for (ofFile file:files) {
                ...
                string fileSize = "";
                if (!file.isDirectory()) fileSize = uiVizShared::Pretty_Bytes(file.getSize());
    ...
    void addCustomFileRow(string TYPE, string key, string title, int rowIndex, string rowKey ) { // type = [DIR|FILE]
