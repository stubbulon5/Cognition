...
public:
    ...
    virtual void update(uiVizWidgetContext context) override {
        ...
        // Slider BG
        getIsRoundedRectangle() ? vizElm_BG.setRectRounded(getSliderBG_x(), scale(getY()), sliderBGSize, scale(getHeight()), scale(5), getTheme().ElementBackgroundColor_withAlpha(getCurrentBackgroundAlpha())) :
        vizElm_BG.setRectangle(getSliderBG_x(), scale(getY()), sliderBGSize, scale(getHeight()), getTheme().ElementBackgroundColor_withAlpha(getCurrentBackgroundAlpha()));
        
        // Slider
        getIsRoundedRectangle() ? vizElm_SLIDER.setRectRounded(sliderX, sliderY, sliderSize, sliderHeight, scale(5), getTheme().ElementBackgroundColor_withAlpha(getCurrentBackgroundAlpha())) :
        vizElm_SLIDER.setRectangle(sliderX, sliderY, sliderSize, sliderHeight, getTheme().ElementBackgroundColor_withAlpha(getCurrentBackgroundAlpha()));
